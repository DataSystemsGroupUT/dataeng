...
public class ShakespeareValue extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ShakespeareValue\",\"namespace\":\"partial.model\",\"fields\":[{\"name\":\"line_number\",\"type\":\"int\",\"doc\":\"The line number for line\"},{\"name\":\"line\",\"type\":\"string\",\"doc\":\"The line from Shakespeare\"}]}");
  ...
  public static partial.model.ShakespeareValue.Builder newBuilder() {
    return new partial.model.ShakespeareValue.Builder();
  }
  
  /** Creates a new ShakespeareValue RecordBuilder by copying an existing Builder */
  public static partial.model.ShakespeareValue.Builder newBuilder(partial.model.ShakespeareValue.Builder other) {
    return new partial.model.ShakespeareValue.Builder(other);
  }
  
  /** Creates a new ShakespeareValue RecordBuilder by copying an existing ShakespeareValue instance */
  public static partial.model.ShakespeareValue.Builder newBuilder(partial.model.ShakespeareValue other) {
    return new partial.model.ShakespeareValue.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ShakespeareValue>
    ...
    private Builder() {
      super(partial.model.ShakespeareValue.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(partial.model.ShakespeareValue.Builder other) {
      super(other);
    ...
    private Builder(partial.model.ShakespeareValue other) {
            super(partial.model.ShakespeareValue.SCHEMA$);
      if (isValidValue(fields()[0], other.line_number)) {
        this.line_number = data().deepCopy(fields()[0].schema(), other.line_number);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'line_number' field */
    public partial.model.ShakespeareValue.Builder setLineNumber(int value) {
    ...
    public partial.model.ShakespeareValue.Builder clearLineNumber() {
    ...
    /** Sets the value of the 'line' field */
    public partial.model.ShakespeareValue.Builder setLine(java.lang.CharSequence value) {
    ...
    public partial.model.ShakespeareValue.Builder clearLine() {
      line = null;
