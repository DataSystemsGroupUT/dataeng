...
public class ShakespeareKey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ShakespeareKey\",\"namespace\":\"partial.model\",\"fields\":[{\"name\":\"work\",\"type\":\"string\",\"doc\":\"The name of the work\"},{\"name\":\"year\",\"type\":\"int\",\"doc\":\"The year the work was published\"}]}");
  ...
  public static partial.model.ShakespeareKey.Builder newBuilder() {
    return new partial.model.ShakespeareKey.Builder();
  }
  
  /** Creates a new ShakespeareKey RecordBuilder by copying an existing Builder */
  public static partial.model.ShakespeareKey.Builder newBuilder(partial.model.ShakespeareKey.Builder other) {
    return new partial.model.ShakespeareKey.Builder(other);
  }
  
  /** Creates a new ShakespeareKey RecordBuilder by copying an existing ShakespeareKey instance */
  public static partial.model.ShakespeareKey.Builder newBuilder(partial.model.ShakespeareKey other) {
    return new partial.model.ShakespeareKey.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ShakespeareKey>
    ...
    private Builder() {
      super(partial.model.ShakespeareKey.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(partial.model.ShakespeareKey.Builder other) {
      super(other);
    ...
    private Builder(partial.model.ShakespeareKey other) {
            super(partial.model.ShakespeareKey.SCHEMA$);
      if (isValidValue(fields()[0], other.work)) {
        this.work = data().deepCopy(fields()[0].schema(), other.work);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'work' field */
    public partial.model.ShakespeareKey.Builder setWork(java.lang.CharSequence value) {
    ...
    public partial.model.ShakespeareKey.Builder clearWork() {
      work = null;
    ...
    /** Sets the value of the 'year' field */
    public partial.model.ShakespeareKey.Builder setYear(int value) {
    ...
    public partial.model.ShakespeareKey.Builder clearYear() {
