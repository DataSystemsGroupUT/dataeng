...
public class ShakespeareConverterConsumerProducer {
	...
	public void createConsumer() throws InterruptedException {
		...
		try (KafkaProducer<Object, Object> producer = new KafkaProducer<Object, Object>(prodProps)) {
			...
			consumer.subscribe(Arrays.asList("shakespeare_topic3"));
			...
			while (true) {
				...
				for (ConsumerRecord<String, String> record : records) {
					...
					// Create the ProducerRecord with the Avro objects and send
					// them

					ProducerRecord<Object, Object> finalRecord = new ProducerRecord<Object, Object>(
							"shakespeare_avro_topic3", shakespeareKey, shakespeareValue);
	...
	private ShakespeareKey getShakespeareKey(String key) {
		...
		// TODO Check if key is work
		// return a ShakespeareKey object containing key and yearWritten
	...
	private ShakespeareValue getShakespeareLine(String line) {
		...
		if (matcher.matches()) {
			...
			// return a ShakespeareValue object with the line number and line of
			// work
