...
public class ShakespeareValue extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    public static solution.model.ShakespeareValue.Builder newBuilder() {
        return new solution.model.ShakespeareValue.Builder();
    }

    /** Creates a new ShakespeareValue RecordBuilder by copying an existing Builder */
    public static solution.model.ShakespeareValue.Builder newBuilder(solution.model.ShakespeareValue.Builder other) {
        return new solution.model.ShakespeareValue.Builder(other);
    }

    /** Creates a new ShakespeareValue RecordBuilder by copying an existing ShakespeareValue instance */
    public static solution.model.ShakespeareValue.Builder newBuilder(solution.model.ShakespeareValue other) {
        return new solution.model.ShakespeareValue.Builder(other);
    }
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ShakespeareValue>
        implements org.apache.avro.data.RecordBuilder<ShakespeareValue> {
            ...
            private Builder() {
                super(solution.model.ShakespeareValue.SCHEMA$);
            }

            /** Creates a Builder by copying an existing Builder */
            private Builder(solution.model.ShakespeareValue.Builder other) {
                super(other);
            ...
            private Builder(solution.model.ShakespeareValue other) {
                super(solution.model.ShakespeareValue.SCHEMA$);
                if (isValidValue(fields()[0], other.line_number)) {
                    this.line_number = data().deepCopy(fields()[0].schema(), other.line_number);
                    fieldSetFlags()[0] = true;
            ...
            /** Sets the value of the 'line_number' field */
            public solution.model.ShakespeareValue.Builder setLineNumber(int value) {
            ...
            public solution.model.ShakespeareValue.Builder clearLineNumber() {
            ...
            /** Sets the value of the 'line' field */
            public solution.model.ShakespeareValue.Builder setLine(java.lang.CharSequence value) {
            ...
            public solution.model.ShakespeareValue.Builder clearLine() {
                line = null;
