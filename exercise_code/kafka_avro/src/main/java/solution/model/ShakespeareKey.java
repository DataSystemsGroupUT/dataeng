...
public class ShakespeareKey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    public static solution.model.ShakespeareKey.Builder newBuilder() {
        return new solution.model.ShakespeareKey.Builder();
    }

    /** Creates a new ShakespeareKey RecordBuilder by copying an existing Builder */
    public static solution.model.ShakespeareKey.Builder newBuilder(solution.model.ShakespeareKey.Builder other) {
        return new solution.model.ShakespeareKey.Builder(other);
    }

    /** Creates a new ShakespeareKey RecordBuilder by copying an existing ShakespeareKey instance */
    public static solution.model.ShakespeareKey.Builder newBuilder(solution.model.ShakespeareKey other) {
        return new solution.model.ShakespeareKey.Builder(other);
    }
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ShakespeareKey>
        implements org.apache.avro.data.RecordBuilder<ShakespeareKey> {
            ...
            private Builder() {
                super(solution.model.ShakespeareKey.SCHEMA$);
            }

            /** Creates a Builder by copying an existing Builder */
            private Builder(solution.model.ShakespeareKey.Builder other) {
                super(other);
            ...
            private Builder(solution.model.ShakespeareKey other) {
                super(solution.model.ShakespeareKey.SCHEMA$);
                if (isValidValue(fields()[0], other.work)) {
                    this.work = data().deepCopy(fields()[0].schema(), other.work);
                    fieldSetFlags()[0] = true;
            ...
            /** Sets the value of the 'work' field */
            public solution.model.ShakespeareKey.Builder setWork(java.lang.CharSequence value) {
            ...
            public solution.model.ShakespeareKey.Builder clearWork() {
                work = null;
            ...
            /** Sets the value of the 'year' field */
            public solution.model.ShakespeareKey.Builder setYear(int value) {
            ...
            public solution.model.ShakespeareKey.Builder clearYear() {
