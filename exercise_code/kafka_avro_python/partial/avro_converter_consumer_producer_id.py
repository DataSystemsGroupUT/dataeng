...
shakespeare_key_partial = open("shakespeare_key_partial.avsc", 'rU').read()
shakespeare_value_partial = open("shakespeare_value_partial.avsc", 'rU').read()
...
keyID = registerOrGetSchemaId("shakespeare_avro_topic-key", shakespeare_key_partial)
# TODO: Do the same for the value
...
# TODO: Create the instance into 'r'
