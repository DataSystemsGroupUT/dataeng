...
public class ShakespeareValue extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    public static ShakespeareValue.Builder newBuilder() {
        return new ShakespeareValue.Builder();
    }

    /** Creates a new ShakespeareValue RecordBuilder by copying an existing Builder */
    public static ShakespeareValue.Builder newBuilder(ShakespeareValue.Builder other) {
        return new ShakespeareValue.Builder(other);
    }

    /** Creates a new ShakespeareValue RecordBuilder by copying an existing ShakespeareValue instance */
    public static ShakespeareValue.Builder newBuilder(ShakespeareValue other) {
        return new ShakespeareValue.Builder(other);
    }
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ShakespeareValue>
        implements org.apache.avro.data.RecordBuilder<ShakespeareValue> {
            ...
            private Builder() {
                super(ShakespeareValue.SCHEMA$);
            }

            /** Creates a Builder by copying an existing Builder */
            private Builder(ShakespeareValue.Builder other) {
                super(other);
            ...
            /** Sets the value of the 'line_number' field */
            public ShakespeareValue.Builder setLineNumber(int value) {
            ...
            public ShakespeareValue.Builder clearLineNumber() {
            ...
            /** Sets the value of the 'line' field */
            public ShakespeareValue.Builder setLine(java.lang.CharSequence value) {
            ...
            public ShakespeareValue.Builder clearLine() {
                line = null;
