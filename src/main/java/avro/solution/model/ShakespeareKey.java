...
public class ShakespeareKey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    public static ShakespeareKey.Builder newBuilder() {
        return new ShakespeareKey.Builder();
    }

    /** Creates a new ShakespeareKey RecordBuilder by copying an existing Builder */
    public static ShakespeareKey.Builder newBuilder(ShakespeareKey.Builder other) {
        return new ShakespeareKey.Builder(other);
    }

    /** Creates a new ShakespeareKey RecordBuilder by copying an existing ShakespeareKey instance */
    public static ShakespeareKey.Builder newBuilder(ShakespeareKey other) {
        return new ShakespeareKey.Builder(other);
    }
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ShakespeareKey>
        implements org.apache.avro.data.RecordBuilder<ShakespeareKey> {
            ...
            private Builder() {
                super(ShakespeareKey.SCHEMA$);
            }

            /** Creates a Builder by copying an existing Builder */
            private Builder(ShakespeareKey.Builder other) {
                super(other);
            ...
            /** Sets the value of the 'work' field */
            public ShakespeareKey.Builder setWork(java.lang.CharSequence value) {
            ...
            public ShakespeareKey.Builder clearWork() {
                work = null;
            ...
            /** Sets the value of the 'year' field */
            public ShakespeareKey.Builder setYear(int value) {
            ...
            public ShakespeareKey.Builder clearYear() {
