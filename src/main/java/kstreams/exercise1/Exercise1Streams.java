...
public class Exercise1Streams {
    ...
    public static void main(String[] args) {
        ...
        KStream<String, String> words = builder.stream("paragraphs", Consumed.with(Serdes.String(), Serdes.String()));
...
//                        .replace("?", " "))
        ...
        wordcounts.to("wordcount-stream-out", Produced.with(Serdes.String(), Serdes.Long()));
