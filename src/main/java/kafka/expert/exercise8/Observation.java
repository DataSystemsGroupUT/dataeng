...
public class Observation extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8861571619755139843L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Observation\",\"namespace\":\"kafka.expert.exercise8\",\"fields\":[{\"name\":\"id\",\"type\":\"long\",\"doc\":\"The observation id\"},{\"name\":\"value\",\"type\":\"double\",\"doc\":\"The actual measurement from the sensor\"},{\"name\":\"measurement\",\"type\":\"string\",\"doc\":\"The measurement type, e.g., temperature\"},{\"name\":\"timestamp\",\"type\":\"long\",\"doc\":\"The measurement timestamp\"}]}");
  ...
  @Deprecated public java.lang.CharSequence measurement;
   ...
   * @param value The actual measurement from the sensor
   * @param measurement The measurement type, e.g., temperature
   * @param timestamp The measurement timestamp
   */
  public Observation(java.lang.Long id, java.lang.Double value, java.lang.CharSequence measurement, java.lang.Long timestamp) {
    this.id = id;
    this.value = value;
   ...
   */
  public static kafka.expert.exercise8.Observation.Builder newBuilder() {
    return new kafka.expert.exercise8.Observation.Builder();
  }
   ...
   * @return A new Observation RecordBuilder
   */
  public static kafka.expert.exercise8.Observation.Builder newBuilder(kafka.expert.exercise8.Observation.Builder other) {
    return new kafka.expert.exercise8.Observation.Builder(other);
  }
   ...
   * @return A new Observation RecordBuilder
   */
  public static kafka.expert.exercise8.Observation.Builder newBuilder(kafka.expert.exercise8.Observation other) {
    return new kafka.expert.exercise8.Observation.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Observation>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(kafka.expert.exercise8.Observation.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(kafka.expert.exercise8.Observation other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.expert.exercise8.Observation.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.expert.exercise8.Observation.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.expert.exercise8.Observation.Builder setValue(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.expert.exercise8.Observation.Builder clearValue() {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.expert.exercise8.Observation.Builder setMeasurement(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.expert.exercise8.Observation.Builder clearMeasurement() {
      measurement = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.expert.exercise8.Observation.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.expert.exercise8.Observation.Builder clearTimestamp() {
